...
function MagneticBtn({
  ...
  const props = {
    ...
    style: {
      ...style,
      transition:
        "transform 0.35s cubic-bezier(0.23,1,0.32,1), background 0.25s, color 0.25s, border-color 0.25s, box-shadow 0.3s",
    },
...
function RedLineAccent({ width = 200 }) {
  return (
    <svg
      ...
      viewBox={`0 0 ${width} 8`}
      fill="none"
      style={{ display: "block", marginBottom: 20, overflow: "visible" }}
    >
      <line
        x1="0"
        y1="4"
      ...
      <line
        ...
        style={{
          animation: "dashDraw 0.8s cubic-bezier(0.16,1,0.3,1) 0.5s forwards",
        }}
      />
      <circle
        cx="0"
        ...
        r="3"
        fill="#E8002D"
        style={{ animation: "dotAppear 0.3s ease 1.2s both" }}
      />
      <circle
        cx={width}
        cy="4"
        r="2"
        fill="rgba(232,0,45,0.4)"
        style={{ animation: "dotAppear 0.3s ease 1.3s both" }}
      />
    </svg>
  );
}
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .hero-title-gap{margin-bottom:32px!important}
      `}</style>
      ...
      >
        ...
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "linear-gradient(transparent 50%,rgba(0,0,0,0.025) 50%)",
        ...
        >
          <div
            style={{
              ...
              height: "80px",
              background:
                "linear-gradient(to bottom,transparent,rgba(232,0,45,0.02),transparent)",
        ...
        <div
          style={{
            ...
            background:
              "radial-gradient(ellipse,rgba(232,0,45,0.14) 0%,transparent 70%)",
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse at 40% 40%,rgba(56,189,248,0.1) 0%,rgba(232,0,45,0.05) 50%,transparent 70%)",
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse,rgba(232,0,45,0.07) 0%,transparent 70%)",
        ...
        <div
          style={{
            ...
            height: "100%",
            background:
              "linear-gradient(to bottom,transparent,#E8002D 30%,#E8002D 70%,transparent)",
            opacity: 0.5,
        ...
        <div
          style={{
            ...
            width: "30%",
            background:
              "linear-gradient(to left,rgba(56,189,248,0.4),transparent)",
        ...
        {[
          ...
          <div
            ...
            style={{
              ...
              borderLeft:
                i === 0 || i === 2 ? "1px solid rgba(232,0,45,0.4)" : "none",
              borderRight:
                i === 1 || i === 3 ? "1px solid rgba(232,0,45,0.4)" : "none",
        ...
        <div style={{ position: "relative", zIndex: 10 }}>
            ...
            >
              ...
              <span
                style={{
                  ...
                  animation: "pulseRing2 2s ease-out .4s infinite",
                }}
              />
              <span
                style={{
            ...
            >
              ...
              <span
                style={{
                  ...
                  width: "100%",
                  background:
                    "linear-gradient(to right,#E8002D,rgba(232,0,45,0.25))",
                  transformOrigin: "left",
                  animation:
                    "stripeExpand .9s cubic-bezier(.16,1,.3,1) 1s both",
                }}
              />
            </span>
          </h1>
          ...
          >
            ...
            <div
              style={{
                ...
                height: 1,
                background:
                  "linear-gradient(to right,#E8002D 0%,rgba(232,0,45,0.25) 40%,transparent 70%)",
                opacity: 0,
              ...
              >
                ...
                <span
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    fontSize: "1.05rem",
                    color: t.green ? "#39d353" : "#b8b8b8",
                    transition: "color .2s,text-shadow .2s",
                  }}
                >
                  {t.num !== null ? (
                    <>
                      <Counter target={t.num} />
                      {t.suffix}
                    </>
                  ) : (
                    t.val
          ...
          >
            ...
            >
              ...
              — from pixel-perfect interfaces to resilient backends. Every
              millisecond matters.
            </p>
